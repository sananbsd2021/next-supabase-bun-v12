...
export default function EdunewsForm({ onSubmit, onClose }: EdunewsFormProps) {
  ...
  return (
    <div className="fixed inset-0 bg-gray-900 bg-opacity-50 flex justify-center items-center z-50">
      ...
      >
        <h2 className="text-lg font-bold mb-4">เพิ่มข่าวการศึกษา</h2>
